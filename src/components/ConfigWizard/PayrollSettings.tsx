...
// ─────────────────────────────────────────────────────────────────────────────
// Payroll Configuration Component (Main Entry)
// ─────────────────────────────────────────────────────────────────────────────
...
export default function PayrollSettings() {
    ...
    // Fixed for demo as requested
    const overallProgress = 100;

    const isReadyToCalculate = overallProgress >= 70;
        ...
        <div className="space-y-8 animate-in fade-in duration-1000 pb-20">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-0.5">
                            <h3 className="text-xl font-light text-zinc-900 tracking-tight">Motores de Impacto & Costes</h3>
                        ...
                        <p className="text-[11px] text-zinc-400 font-light tracking-wide">Configuración avanzada de los algoritmos de cálculo, costes de sustitución y parámetros de nómina.</p>
                    </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-1.5 bg-zinc-50/40 rounded-[28px] border border-zinc-100/50">
                ...
                <div className="flex items-center gap-2 mr-1">
                    ...
                    <button
                        onClick={() => openCopilot('impact-engines')}
                        className="h-10 px-5 rounded-[20px] bg-zinc-900 border border-zinc-800 flex items-center gap-2 text-[9px] font-medium text-white uppercase tracking-wider hover:bg-zinc-800 transition-all active:scale-95 shadow-sm"
                    >
